...
df_base = Model.get_csv(r'C:\Users\20212387\OneDrive - TU Eindhoven\Documents\Y2\DBL process mining\ProcessMining\BPI_Challenge_2012.csv')
...
Graphs.tt_split_graph(df_base, df_train, df_test)
